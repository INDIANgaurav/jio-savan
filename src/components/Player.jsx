  ...
  return (
    <div className="fixed bottom-0 right-0 left-0 bg-[#f5f5f5ff] flex  flex-col  ">
      <input
       ...
       text-green-400  range "
      />
      <div className="flex justify-between items-center mb-3 px-3   " >
        <div className="flex justify-center items-center gap-3 lg:w-[30vw] ">
          <img
        ...
        <div className="flex text-2xl lg:text-3xl gap-4 lg:gap-6 lg:w-[40vw] justify-center">
          ...
          <FaPlay className="text-green-700 hover:text-gray-500 cursor-pointer      " />
        ...
        {/* 3rd div */}
        <div className="flex lg:w-[30vw] justify-end  items-center" onMouseEnter={() => setIsVolumeVisible(true)}
